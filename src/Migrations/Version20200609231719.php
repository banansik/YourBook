 ...
 */
final class Version20200609231719 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservations (id INT AUTO_INCREMENT NOT NULL, book_name_id INT DEFAULT NULL, book_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, comment TINYTEXT DEFAULT NULL, created_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_4DA239E237B440 (book_name_id), INDEX IDX_4DA23916A2B381 (book_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE reservations ADD CONSTRAINT FK_4DA23916A2B381 FOREIGN KEY (book_id) REFERENCES reservations (id)');
    }
